...
<div class="content read">
	<h2>Found objects</h2>
	<a href="create.php" class="create-object">Createfoundobject</a>
	<table>
        <thead>
            <tr>
                <td>#</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <a href="update.php?id=<?=$found['foundobj_id']?>" class="edit">Edit</a>
                    <a href="delete.php?id=<?=$found['foundobj_id']?>" class="trash">Delete</i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
